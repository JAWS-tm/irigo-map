  ...
  return (
    <div className="Help">
      ...
      <div className="description">
        <div id="title_help">
          <h3>Je n'arrive pas à accéder à la Map</h3>
          <br />
          <p>
            Pour accéder à la Map ou à la carte, vous devez d'abord vous indentifier ou créer un
            compte
          </p>
        </div>
        <div id="title_help">
          ...
          <br />
          <p>
            Vous devez vous connecter, ensuite rendez vous sur l'onglet "Outils" dans la navbar.
          </p>
          <p>Une fois connecter choisisez la demande que vous souhaitez</p>
        </div>
      </div>
      <div className="description">
        <div id="title_help">
          ...
          <br />
          <p>Rendez vous sur l'ongel "Carte" de la navbar.</p>
          <p>
